    ...
    <script type="text/javascript">
        ...
        function commentPublish() {
            ...
            xhr.onload=function (){
                ...
                document.getElementById("pl").style.display="none"
                window.open("PostDetails.jsp?id=<%=id%>&startid=<%=pageid%>","mainFrame")
            }
            xhr.send(data);
        }
    </script>
...
<body>
<div><a style="text-decoration: none;color: grey" href="PostsTypeShowAll.jsp?type=<%=postsList1.get(i).getPoststype()%>&startid=<%=pageid%>">《返回</a></div>
    <div>
