...
<html>
<head>
    <title>帖子详情--<%=postsList1.get(i).getPostsname()%></title>
    <script type="text/javascript">
        ...
        function commentPublish() {
            ...
            xhr.onload=function (){
                ...
                document.getElementById("pl").style.display="none"
                window.open("PostDetails_userComment.jsp?id=<%=id%>&username=<%=username%>","mainFrame")
            }
            xhr.send(data);
        }
    </script>
...
<body>
<div><a style="text-decoration: none;color: grey" href="userComment.jsp?username=<%=username%>">《返回</a></div>
    <div>
            ...
            <span  style="font-size: 15px;float: left;margin-left: 30px;color: #4682B4">
                <p>
